...
return [
    ...
    'origins' => array_filter(explode(',', env('AUTH_ALLOWED_ORIGINS', env('APP_ENV') === 'production' ? implode(',', [env('APP_URL', ''), 'tauri://localhost', 'https://tauri.localhost', 'http://tauri.localhost']) : implode(',', [
